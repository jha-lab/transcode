...
from transformers.models.bert.modeling_dtbert import DTBertModel, DTBertForMaskedLM, DTBertForSequenceClassification
import json
...
def main(args):
    ...
    model = DTBertForSequenceClassification.from_pretrained(
